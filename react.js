...
var ReactCompositeComponentMixin = {
  ...
  mountComponent: function (transaction, nativeParent, nativeContainerInfo, context) {
    ...
    if ("development" !== 'production') {
      ...
      // logic, we can not catch commonJS errors early. Therefore, we have to
...
// maintain-order a list rather than create a `trapBubbledEvent` for each
var mediaEvents = {
  topAbort: 'abort',
  topCanPlay: 'canplay',
  topCanPlayThrough: 'canplaythrough',
...
/**
 * Return the lowest commonJS ancestor of A and B, or null if they are in
 * different trees.
 */
 ...
 *
 * Does not invoke the callback on the nearest commonJS ancestor because nothing
 ...
 * that's not commonJS between the two given strings.
 *
...
var ReactMultiChild = {
  ...
  /**
   * Provides commonJS functionality for components that must reconcile multiple
...
if ("development" !== 'production') {
  ...
  validateDOMNesting = function (childTag, childInstance, ancestorInfo) {
    ...
    if (problematic) {
      ...
      // If the parent and child instances have a commonJS owner ancestor, start
