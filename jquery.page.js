...
(function($){
	...
	function Page(container,fn,args,style){
		...
		var height=this.height=28;//parseInt(this.obj.bootstrapCss('height'));
        console.log(width);
        var style=this.style=$.extend({
			"fontSize":14,//字体大小
			"width":width,//页码盒子总宽度
			"height":height,//页码总高度，默认20px
			"pagesMargin":10,//每个页码或按钮之间的间隔
			"paddL":0,//左边留白
			"paddR":0,//右边留白
			"borderColor":"#3DB5D5",//边线颜色
		...
		//设置容器样式
		this.container.css({'pading-left':style.paddL+'px','pading-right':style.paddR+'px','content':'','display':'block','clear':'both','text-align':'center'});
		//建立自己的容器
		this.container.html('<div></div>');
		this.obj=this.container.children();
		this.obj.css({'content':'','display':'inline-block','clear':'both','text-align':'center','margin':'0px auto'});
		//初始化
		this.init();
	}
	...
	Page.prototype.setStyle=function(){
		...
		this.obj.find('a.prevPage').css({'position':'relative','width':'70px','font-size':s.fontSize+'px','height':s.height+'px','line-height':s.height+'px','background-color':'#fff','border':'1px solid #3db5d5','color':'#3db5d5'});
		this.obj.find('a.nextPage').css({'position':'relative','width':'70px','font-size':s.fontSize+'px','height':s.height+'px','line-height':s.height+'px','background-color':'#fff','border':'1px solid #3db5d5','color':'#3db5d5'});

		this.obj.find('a.turndown').css({'margin-left':'5px','display':'inline-block','width':'24px','height':s.height+'px','line-height':s.height+'px'});

		this.obj.find('span.current').css({'font-size':'14px','display':'inline-block','height':s.height+'px','line-height':s.height+'px','color':s.currentColor,'vertical-align':'middle','background-color':'#3db5d5','color':'#fff','width':'30px'});

		this.obj.find('span.disabled').css({'position':'relative','display':'inline-block','height':s.height+'px','line-height':s.height+'px','color':s.disableColor,'background':s.disableBackColor,'border':'1px solid #bfbfbf','vertical-align':'middle','font-size':s.fontSize+'px','width':'70px'});
		...
		this.obj.find('input').css({'outline':'none','border':'1px solid #ddd','height':s.height+'px','line-height':s.height+'px','width':'30px',margin: '0 5px'});


		this.obj.find('.tcdNumber').css({'width':'28px','height':s.height+'px','line-height':s.height+'px','font-size':s.fontSize+'px','color':'#3db5d5'});
		this.obj.find('.hiding').css({'width':'28px','height':'28px','line-height':'28px','border':'1px solid '+s.borderColor,'color':'#3db5d5'});
